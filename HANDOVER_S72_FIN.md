...
- 116 pages compilées (était 119 avec BL/BR/DAF déjà incluses depuis S71)
...
| Commit | Hash | Description |
|---|---|---|
| — | *(ORANGE S73)* | changelog S72 + roadmap S73 + pilotage + API ref |
...
## 4. Données de test — Déclarations
...
Toutes les échéances sont dépassées → toutes affichées en retard (fond rouge)
```
...
| Item | Action |
|---|---|
| Docs GitHub Pages S72 | changelog S72 + roadmap S73 + 20-pilotage-projet.html (99/98/92/98) + 17-api-reference.html |
...
# 1. ORANGE — Docs GitHub Pages S72
Set-Location "C:\AnimGest_Sav"
git pull --rebase
# Créer changelog-sprint-S72.html
# Mettre à jour 06-roadmap.html (S73 en cours)
# Mettre à jour 20-pilotage-projet.html (99/98/92/98)
# Mettre à jour 17-api-reference.html si nouvelles routes
...
| Déclarations | 16 entrées, toutes A_FAIRE, types SCC/LOOF |

---

*Anim'Gest — NoSage's Editor — Handover S72 FIN — 08/04/2026*
